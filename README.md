...
LiaScript ist eine innovative Plattform, die es ermöglicht, interaktive Lerninhalte direkt in Markdown zu schreiben und zu teilen. Dozierende können LiaScript nutzen, um dynamische Kursmaterialien zu erstellen, die Videos, Quizze und programmierbare Codeblöcke enthalten, um den Lernstoff lebendig und ansprechend zu gestalten. Studierende profitieren von der interaktiven Natur der Inhalte, die es ihnen ermöglicht, Konzepte durch Übungen und sofortiges Feedback besser zu verstehen. Die einfache Integration in bestehende Lernmanagementsysteme einer Fachhochschule ermöglicht einen nahtlosen Zugriff für alle Beteiligten. Darüber hinaus fördert die Nutzung von LiaScript die Entwicklung digitaler Kompetenzen sowohl bei Lehrenden als auch bei Lernenden. Da keine vorherigen Programmierkenntnisse erforderlich sind, können alle Nutzer*innen ohne technische Hürden von den Vorteilen profitieren. Mit LiaScript können Dozierende den Lernprozess personalisieren und an die individuellen Bedürfnisse ihrer Studierenden anpassen. Es unterstützt eine Vielzahl von Lehr- und Lernstilen, von visuell bis kinästhetisch, und macht Bildung zugänglicher und effektiver.
...
Zunächst muss die jeweilige Webseite angeklickt werden

**Wie kann ich in Liascript navigieren**

<iframe width="560" height="315" src="https://www.youtube.com/embed/EZtBdVh5TY8?si=4jaMeoEn9JJZEjiQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

## 🫅 Administrator*innenperspektive
Es existieren mehre Möglichkeiten Liascripte herzustellen.

Variante a: Direkt im Liascriptliveeditor, der unter: https://liascript.github.io/LiveEditor/ abrufbar ist.

Variante b: Innerhalb von github

### Andministrator*innentutorial- Überblick

<div style="width:80%;height:0;padding-bottom:56%;position:relative;"><iframe src="https://giphy.com/embed/7bVpWDbdHRt5MVKgyv" width="80%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/PROSIS-GmbH-produkte-prosis-gustaff-7bVpWDbdHRt5MVKgyv">via GIPHY</a></p>

Dieser Kurs gibt einen Einstieg in den Umgang mit Liascript und zeigt auf wozu Liascript pädagogisch genutzt werden kann.
Im __ersten Teil__ werden die Grundlagen von Markdown erläutert, das die Grundlage von Liascript darstellt.

Im __zweiten Teil__ werden interaktive LiaScript-Erweiterungen erörtert, so bspw. das Einbinden von Videos/Audios oder auch [H5P Inhalten](https://https://elesana.de/was-ist-h5p/).

Der __dritten Teil__ befasst sich mit der Frage was LiaScript ist und welche Möglichkeiten diese Erweiterung von Markdown eröffnet.

Im __vierten Teil__ wird ASCII-Art sowie verschiedene Tabellenformate erörtert.

Der __fünfte Teil__ zeigt auf, wie Formeln in LiaScript dargestellt werden.

Im __sechsten Teil__ wird ausführbarere Code thematisiert.

Der __siebte Teil__ befasst sich mit Projekten.

Im __achten Teil__ werden Macros und verschiedene Bibliotheken thematisiert.

Der __neunte Teil__ Thematisiert die Möglichkeiten des Imports.

Mit dem __zehnten Teil__ endet das Tutorial schließlich mit der Erläuterung wie H5P inhalte mittels lumi inkludiert werden können.


!?[Erste Schritte](https://youtu.be/aq7hd3bOarQ?si=hfIJfQDj2xdweZBT)

## 1. Markdown 🖊
<div style="width:100%;height:0;padding-bottom:100%;position:relative;"><iframe src="https://giphy.com/embed/Mab0KOwgfcmrPQpxhV" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/slickbiz-slick-business-waaaaaaah-Mab0KOwgfcmrPQpxhV">via GIPHY</a></p>

Als Grundlage von Liascrip dient die Ausgangssprache Markdown.
